...
namespace Laba2 {
    ...
    public partial class AppDbDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, string Specialty, string Group) {
...
namespace Laba2.AppDbDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Specialty], [Group]) VALUES (@Name, @Speci" +
                "alty, @Group);\r\nSELECT Id, Name, Specialty, [Group] FROM Students WHERE (Id = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [Name] = @Name, [Specialty] = @Specialty, [Group] = @" +
                "Group WHERE (([Id] = @Original_Id));\r\nSELECT Id, Name, Specialty, [Group] FROM S" +
                "tudents WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Laba2.Properties.Settings.Default.AppDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Specialty, [Group] FROM dbo.Students";
        ...
        public virtual int Fill(AppDbDataSet.StudentsDataTable dataTable) {
        ...
        public virtual AppDbDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppDbDataSet.StudentsDataTable dataTable = new AppDbDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppDbDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Insert(string Name, string Specialty, string Group) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Specialty, string Group, int Original_Id, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Specialty, string Group, int Original_Id) {
            return this.Update(Name, Specialty, Group, Original_Id, Original_Id);
        }
    }
